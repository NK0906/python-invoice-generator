...
def loginWindow():
    titleLabel = Label(window,text="Restaurant invoice application",font="Arial 40",fg="green")
...
def mainwindow():
    ...
    titleLabel = Label(window,text="Restaurant invoice application",font="Arial 30",fg="green")
...
def itemAddWindow():
    ...
    titleLabel = Label(window,text="Restaurant invoice application", width=40,font="Arial 30",fg="green")
